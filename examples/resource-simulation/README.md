...
Copyright 2026 Violet Herod. This simulator is included in the free-use terms under [LICENSE](LICENSE). Historical sample, client, conformance and resource-simulation uses are permitted. See the [licensing boundaries](../../LICENSING.md). The simulator holds no issuer signing keys and issues or settles no receipts or payments.
